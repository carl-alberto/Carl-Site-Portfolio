...
class Contribution extends AbstractPostType {
    ...
    public function register_meta_fields() {
        register_post_meta( 'contribution', 'event_date', [
            'type' => 'string',
            'description' => 'Event date',
            'single' => true,
            'show_in_rest' => true,
        ] );
        register_post_meta( 'contribution', 'role', [
            'type' => 'string',
            'description' => 'Role',
            'single' => true,
            'show_in_rest' => true,
        ] );
        register_post_meta( 'contribution', 'url', [
            'type' => 'string',
            'description' => 'URL',
            'single' => true,
            'show_in_rest' => true,
        ] );
        register_post_meta( 'contribution', 'slides_url', [
            'type' => 'string',
