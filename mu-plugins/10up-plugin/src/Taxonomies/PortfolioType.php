 ...
 * PortfolioType Taxonomy.
 */
class PortfolioType extends AbstractTaxonomy {
	...
	public function get_singular_label() {
		return esc_html__( 'Portfolio Type', 'tenup-plugin' );
	}
	...
	public function get_plural_label() {
		return esc_html__( 'Portfolio Types', 'tenup-plugin' );
	}
